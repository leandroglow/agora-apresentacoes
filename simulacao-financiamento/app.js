...
form.addEventListener('submit',async event=>{
 ...
 const payload={propertyValue,monthlyIncome,phone,birthDate:form.birthDate.value,city:form.city.value.trim(),state:form.state.value,propertyType:form.propertyType.value,fgts:form.fgts.value==='true',multipleBuyers:form.multipleBuyers.checked,previousSubsidy:form.previousSubsidy.checked,otherProperty:form.otherProperty.checked,consent:true};
